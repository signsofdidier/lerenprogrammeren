...
/*let nummer = parseInt(prompt("geef een nummer"));

if((nummer % 3 === 0 && nummer % 5 === 0) || (nummer ){
    console.log(`${nummer} is deelbaar door 3 en 5`);
}else if (nummer%3 === 0){
    console.log(`${nummer} is deelbaar door 3`);
} else if (nummer%5 === 0) {
    console.log(`${nummer} is deelbaar door 5`);
} else{
    console.log(`${nummer} nummer is niet deelbaar door 3 of 5`);
}*/
